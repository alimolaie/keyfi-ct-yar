...
تجهیزات و لوازم موردنیاز: 
فانتوم آب سی تی اسکن در ابعاد مختلف (بدین منظور می توان از ظروف استوانه ای شکل پلاستیکی که دارای قطرهای مختلف بوده و محتوای آب باشند استفاده نمود). 
...
تجهیزات و لوازم موردنیاز: 
1-  فانتوم سر یا بدن سی تی اسکن که دارای یک الگوی مناسب با فواصل معین باشد. 
برای این منظور می توان یک الگو که دارای یک یا چند عنصر کوچک با فواصل معین و دقیق باشد استفاده کرد. 
