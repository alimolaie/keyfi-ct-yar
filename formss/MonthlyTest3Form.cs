...
namespace formss
{
    public partial class MonthlyTest3Form : Form
    {
        ...
        private void SetupDataGridView()
        {
            ...
            dataGridView1.Columns.Add("Column1", "نوع الگوریتم بازسازی مورد استفاده");
        ...
        public MonthlyTest3Form()
        {
            InitializeComponent();
        }

        private void MonthlyTest3Form_Load(object sender, EventArgs e)
        {
            SetupDataGridView();
        }
